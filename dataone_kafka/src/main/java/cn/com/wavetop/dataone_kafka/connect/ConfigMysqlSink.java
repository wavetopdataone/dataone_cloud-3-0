...
public class ConfigMysqlSink {
    ...
    private String connection_url = "jdbc:mysql://192.168.1.226:3306/testkafkamessage?user=root&password=888888";
...
//    private String connection_password = "test2";
    ...
    public ConfigMysqlSink(long jobId, String destTable, SysDbinfo sysDbinfo) {
