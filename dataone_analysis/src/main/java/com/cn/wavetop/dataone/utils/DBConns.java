...
public class DBConns {
     ...
     * @return
     */
    public static Connection getMySQLConn() throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
...
//     * 获取达梦数据库对象
//     */
    public static Connection getDaMengConn() throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        String url = "jdbc:dm://192.168.1.25:5236/DMSERVER";
