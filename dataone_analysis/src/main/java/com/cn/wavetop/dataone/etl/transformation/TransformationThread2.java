...
// */
//
//public class TransformationThread2 extends Thread {
...
//
//
//    public TransformationThread2(Long jobId, String tableName, Connection conn, int sync_range) {
//        this.jobId = jobId;
...
//        consumer.subscribe(Arrays.asList(tableName + "_" + jobId));
//        while (true) {
//            List<Map> datamaps = fullTrans(consumer); // 清洗
//            Loading loading = newInstanceLoading();
...
//    }
//
//    private List<Map> fullTrans(KafkaConsumer consumer) {
